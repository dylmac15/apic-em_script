"""
Path Trace Dylan Maclellan Work File
APIC-EM Workshop
December 14, 2018
"""
#==================================================
...
while True:
    ...
    # IP address"
    s_ip = input("Please enter the source host IP address: ")  # Request user input for source host IP address, e.g. "Please enter the source host IP address"
    d_ip = input("Please enter the destination host IP address: ")  # Request user input for destination host IP address, e.g. "Please enter the destination host IP address"
    #++++++++++++++++++++++++++++++++++++
    ...
    if s_ip != "" or d_ip != "":
        ...
        validation=input("Are ips valid?(y for yes other answers mean no)")
        if validation!='y':
            print("\n\nInputs are invalid.\nUSE CTRL-C TO QUIT\n")
            continue
